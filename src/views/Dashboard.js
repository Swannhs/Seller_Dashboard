                                ...
                                <Row>
                                    <Col xs="5">
                                        <div className="icon-big text-center icon-warning">
                                            <i className="nc-icon fas fa-user-clock text-warning"/>
                                        </div>
                                    </Col>
                                    <Col xs="7">
                                        <div className="numbers">
                                            <p className="card-category">Time</p>
                                            <Card.Title as="h4">4 hours</Card.Title>
                                        </div>
                                    </Col>
                                </Row>
                            </Card.Body>
                        ...
                        <Card className="card-stats">
                            <Card.Body>
                                <Row>
                                    <Col xs="5">
                                        <div className="icon-big text-center icon-warning">
                                            <i className="nc-icon fas fa-users text-success"/>
                                        </div>
                                    </Col>
                                    <Col xs="7">
                                        <div className="numbers">
                        ...
                        <Card className="card-stats">
                            <Card.Body>
                                <Row>
                                    <Col xs="5">
                                        <div className="icon-big text-center icon-warning">
                                            <i className="nc-icon fas fa-skating text-danger"/>
                                        </div>
                                    </Col>
                                    <Col xs="7">
                                        <div className="numbers">
                                            <p className="card-category">Active</p>
                                            <Card.Title as="h4">40</Card.Title>
                                        </div>
                                    </Col>
                                </Row>
                            </Card.Body>
